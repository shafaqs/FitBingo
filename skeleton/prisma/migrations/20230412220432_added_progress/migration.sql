/*
  ...
  - Added the required column `inProgress` to the `Bingo_Square` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Bingo_Square" ("bingoBoardId", "exerciseId", "id", "isCompleted", "position") SELECT "bingoBoardId", "exerciseId", "id", "isCompleted", "position" FROM "Bingo_Square";
